...
//           this.connectedFauxDOM[name] =
//             typeof node !== "string" ? node : new Element(node);
...
//       },
//     });
//     WithFauxDOM.displayName =
//       "WithFauxDOM(" + getDisplayName(WrappedComponent) + ")";
...
// export default withFauxDOMFactory;
